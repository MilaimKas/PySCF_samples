...
# Calculate Hessian
# PySCF returns thye hessian as 4 dim array (at1, at2, dim1, dim2)
...
h_ES = h_ES.transpose(0, 2, 1, 3).reshape(mol.natm*3, mol.natm*3)
...
freq_GS = to_wavenumber * np.sort(freq_GS)[-3:]
freq_ES = to_wavenumber * np.sort(freq_ES)[-3:]
